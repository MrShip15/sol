...
void Widget::initializeGL() {
    ...
    m_planetProgram.addShaderFromSourceFile(QOpenGLShader::Vertex, ":/Shaders/planetVertShader.glsl");
    m_planetProgram.addShaderFromSourceFile(QOpenGLShader::Fragment, ":/Shaders/planetFragShader.glsl");
    m_planetProgram.link();

    m_sunProgram.create();
    m_sunProgram.addShaderFromSourceFile(QOpenGLShader::Vertex, ":/Shaders/sunVertShader.glsl");
    m_sunProgram.addShaderFromSourceFile(QOpenGLShader::Fragment, ":/Shaders/sunFragShader.glsl");
    m_sunProgram.link();
    ...
    m_planets[0].color = QColor(185, 176, 80, 255);
    ...
    m_planets[1].color = QColor(113, 175, 60, 255);
    ...
    m_planets[2].color = QColor(145, 109, 192, 255);
    ...
    m_planets[3].color = QColor(129, 193, 108, 255);
    ...
    m_planets[4].color = QColor(165, 123, 80, 255);
    ...
    m_planets[5].color = QColor(165, 123, 80, 255);
    ...
    m_planets[6].color = QColor(165, 123, 80, 255);
    ...
    m_planets[7].color = QColor(165, 123, 80, 255);
    ...
    m_planets[8].color = QColor(165, 123, 80, 255);
    ...
    m_satellites[0].color = QColor(255, 255, 255, 255);
    ...
    m_asteroids[0].color = QColor(255, 255, 255, 255);
    m_asteroids[0].x = 0.f;
    m_asteroids[0].y = 0.f;
...
void Widget::resizeGL(int w, int h) {
    ...
    m_projMatrix.perspective(60.f, (float) w / h, 0.1f, 1000.f);
}
